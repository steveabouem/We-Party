export const newmemberTemplate= (newMember, venue, date, membersList) => {
      ...
      <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
        <tr>
          <td style="padding:18px 0px 18px 0px;line-height:22px;text-align:justify;"
              ...
              valign="top"
              bgcolor="">
              <div style="text-align: center;">${member.firstName} has just joined your party for : ${venue}, ${date}.</div>
