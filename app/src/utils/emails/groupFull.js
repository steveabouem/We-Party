export const fullGroupTemplate= (newMember, venue, date, membersList) => {
  ...
  <html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
      <center class="wrapper" data-link-color="#d44672" data-body-style="font-size: 14px; font-family: verdana,geneva,sans-serif; color: #615252; background-color: #fefefe;">
        <div class="webkit">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td>
                            ...
                            <![endif]-->
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width:750px;" align="center">
                              <tr>
                                <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #615252; text-align: left;" bgcolor="#e8e8e8" width="100%" align="left">
                                  
      <table class="module preheader preheader-hide" role="module" data-type="preheader" border="0" cellpadding="0" cellspacing="0" width="100%"
             style="display: none !important; mso-hide: all; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">
        <tr>
          <td role="module-content">
            <p>Your party group is ready!</p>
          </td>
        </tr>
      </table>
      ...
      <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
        <tr>
          <td style="padding:18px 0px 18px 0px;line-height:22px;text-align:justify;"
              ...
              valign="top"
              bgcolor="">
              <div style="text-align: center;">${newMember.firstName} has just joined your party for : ${venue}, ${date}.
                Your group is now complete! The participants are ${membersList}.
              </div>
