        ...
        {this.props.userInfo.joinedList.length > 0? this.props.userInfo.joinedList.map( match =>{
           ...
           return (
            <ul className="matched-item" key={this.props.activitiesList.indexOf(match)}>
                  ...
                  <li> 
                    Member's contribution: { match.activity.activity.contribution }
                  </li>
                  <li>
                  ...
                  <li>
                    So far there are {match.activity.activity.members.length -1} people partying:
                    - {match.activity.activity.members.map( member => {
                      return <span> <b>{ member.name }</b> { member.email } )</span>
                      })
                    } -
                  </li>
                  <li>Created on { match.activity.activity.created }.</li>
                </ul>
